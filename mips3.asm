...
# // Inputs:	x is n*m, y is m*p and z is n*p matrix
...
B:	.double	9.0, 8.0, 7.0, 6.0, 5.0, 4.0
C:	.space	96	# 12 * 8 bytes
...
# leaf procedure
# inputs in $a0 = x, $a1 = y, $a2 = z
# temporaries used: $s0,$s1,$s2 $t0,$t1
